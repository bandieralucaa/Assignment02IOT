...
#define IDEALLY_TIME (50) //100

#define SCHEDULE_BASE_PERIOD (50)

#define PIR_PERIOD ((int)(SCHEDULE_BASE_PERIOD * 5 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
#define LED_BLINKING_PERIOD ((int)(SCHEDULE_BASE_PERIOD * 1 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
#define SERVO_MOTOR_PERIOD ((int)(SCHEDULE_BASE_PERIOD * 1.5 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
#define BUTTON_PERIOD ((int)(SCHEDULE_BASE_PERIOD * 2 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
#define SONAR_PERIOD ((int)(SCHEDULE_BASE_PERIOD * 5 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
#define IOMAN_PERIOD ((int)(SCHEDULE_BASE_PERIOD * 10 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
