...
#define PIR_PERIOD 450//((int)(SCHEDULE_BASE_PERIOD * 4.5 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
...
#define BUTTON_PERIOD 300 //((int)(SCHEDULE_BASE_PERIOD * 1 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
#define SONAR_PERIOD 600 //((int)(SCHEDULE_BASE_PERIOD * 2.5 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME)))
...
#define N3_TIME (20000 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME))
