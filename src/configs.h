...
#define PIR_PERIOD (SCHEDULE_BASE_PERIOD * 4 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME))
#define LED_BLINKING_PERIOD (SCHEDULE_BASE_PERIOD * 1 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME))
#define SERVO_MOTOR_PERIOD (SCHEDULE_BASE_PERIOD * 1 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME))
#define BUTTON_PERIOD (SCHEDULE_BASE_PERIOD * 1 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME))
#define SONAR_PERIOD (SCHEDULE_BASE_PERIOD * 2 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME))
#define IOMAN_PERIOD (SCHEDULE_BASE_PERIOD * 10 * (SCHEDULE_BASE_PERIOD / IDEALLY_TIME))
